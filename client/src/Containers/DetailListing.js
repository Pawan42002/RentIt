			...
			<div className="bg-gray-100 h-screen">
				<div className="flex flex-col max-w-lg  rounded-lg  mx-auto bg-gray-100">
					<div class="relative flex items-center justify-center overflow-hidden">
						<div
							class="absolute left-0 z-10 p-2 bg-white rounded-full shadow-lg cursor-pointer transform transition-transform duration-300 hover:scale-110"
							onClick={() => {
						...
						<div
							class="absolute right-0 z-10 p-2 bg-white rounded-full shadow-lg cursor-pointer transform transition-transform duration-300 hover:scale-110"
							onClick={() => {
