...
function Login() {
	...
	const handleSubmit = async () => {
		...
		try {
			...
			toast("Please Check Credentials And try again.");
		}
	};

	return (
		<div className="h-screen py-4 flex flex-col flex-grow items-center justify-center bg-gray-100 dark:bg-gray-800">
			<div className="flex flex-col mx-3 bg-white dark:bg-gray-700 shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-lg w-50 max-w-sm">
