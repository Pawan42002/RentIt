            ...
            <div className="image-input block">
              ...
              {images.length ? (
                <div className="block p-2">
                  ...
                  <div className="flex flex-row overflow-x-auto my-2 gap-1 no-scrollbar">
                    {images.map((image) => {
                      return (
                        <div className="relative h-72 min-w-max border-2 rounded-lg">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="absolute text-red-400 top-0 right-0 h-6 w-6"
                            fill="transparent"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                            strokeWidth="2"
